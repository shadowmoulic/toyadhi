    ...
    if (isSubmitted) {
        return (
            <div className="roi-card animate-up visible" style={{ background: 'rgba(59, 130, 246, 0.1)', border: '1px solid var(--secondary)' }}>
                <div className="hero-badge" style={{ background: 'var(--secondary)', color: '#fff' }}>Priority Analysis Complete</div>
                <h2 className="journey-title" style={{ marginTop: '1rem' }}>Potential Annual ROI</h2>
                <div className="roi-value" style={{ fontSize: 'clamp(3rem, 10vw, 5.5rem)' }}>₹45L - ₹65L</div>
                <p className="journey-desc" style={{ color: '#fff' }}>Based on your {formData.landSize} land in {formData.location}, you qualify for an <strong>Integrated Smart Node</strong> model.</p>
